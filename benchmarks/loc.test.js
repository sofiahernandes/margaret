...
const cases = [
  ...
  [
    "plain block comment not counted",
    score(
      "```js\nfunction f() {\n  /* explain\n     the rest */\n  return 1;\n}\n```",
    ),
    3,
  ...
  [
    "jsdoc block comment not counted",
    score(
      "```js\nfunction g() {\n  /*\n   * explain\n   */\n  return 2;\n}\n```",
    ),
    3,
  ...
  [
    "inline block comment keeps its code line",
    score("```js\nconst x = 1; /* note */\nconst y = 2;\n```"),
    2,
  ],
  [
    "line comments still stripped",
    score("```js\n// header\nconst x = 1;\n```"),
    1,
  ],
  ["plain code unchanged", score("```js\nconst a = 1;\nconst b = 2;\n```"), 2],
  [
    "CRLF fences parsed correctly",
    score("```js\r\nconst a = 1;\r\nconst b = 2;\r\n```"),
    2,
  ],
];
